...
const Hero = () => {
  ...
  return (
    <section id="home" className="h-screen flex items-center relative overflow-hidden bg-white pt-20 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-5 gap-8 items-center h-full">
          {/* Left Column - Text Content (3 columns) */}
          <div className="lg:col-span-3">
            {/* Main headline */}
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-neutral-900 mb-3 animate-slide-up leading-tight">
            ...
            {/* Subtitle */}
            <div className="animate-slide-up mb-5" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="flex flex-wrap gap-3 animate-slide-up" style={{ animationDelay: '0.3s' }}>
              <a
                href="#projects"
                className="group inline-flex items-center justify-center bg-primary-600 text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-primary-700 transition-all duration-300 shadow-lg text-sm"
              >
                View My Work
              ...
              <a
                href="#contact"
                className="inline-flex items-center justify-center bg-white border-2 border-primary-600 text-primary-600 px-5 py-2.5 rounded-lg font-semibold hover:bg-primary-50 transition-all duration-300 text-sm"
              >
                Let's Collaborate
              </a>
            </div>
            ...
            <div className="relative bg-gradient-to-br from-primary-50 to-neutral-50 rounded-xl p-6 border border-primary-200 overflow-hidden mt-6 animate-slide-up" style={{ animationDelay: '0.4s' }}>
              <svg className="w-10 h-10 text-primary-300/40 mb-3" fill="currentColor" viewBox="0 0 24 24">
                <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
              </svg>
              <p className="text-lg md:text-xl font-medium text-neutral-700 leading-relaxed relative z-10 italic">
          ...
          <div className="lg:col-span-2 relative animate-fade-in h-full flex items-end" style={{ animationDelay: '0.2s' }}>
